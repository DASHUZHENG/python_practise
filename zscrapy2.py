...
class ZCrawler():
    ...
    def __init__(
        ...
        self.Downloader = ZDownload(
            delay, agent, proxy, num_retries, use_cache, cache)
    ...
    def __call__(
        ...
        if cat == "LINK":
            ...
            result = self.threaded_crawler(
                url, max_depth, max_iteration, threads)
    ...
    def get_links(self, html):
        ...
        def eu_filter(x): return re.match(".+eu4", x)
    ...
    def threaded_crawler(
        ...
        def thread_pop():
            ...
            # print 'thread %s start up after 5s...' %
